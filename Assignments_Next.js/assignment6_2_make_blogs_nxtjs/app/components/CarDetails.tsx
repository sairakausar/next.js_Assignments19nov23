...
const CarDetails = ({
  fromSimpleCardToDetailCard,
  closeDetailsPage,
  isDetailPageOpen,
}: CardDetailsProps) => {
  console.log(fromSimpleCardToDetailCard);
  return (
    <>
      <Transition appear show={isDetailPageOpen} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={closeDetailsPage}>
          <Transition.Child
            as={Fragment}
