...
const NextVideo = (0, import_react.forwardRef)((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "next-video-container", children: [
  ...
  if (asset) {
    if (asset.status === "ready") {
      ...
      if (playbackId) {
        ...
        props.poster ?? (props.poster = (0, import_utils.getPosterURLFromPlaybackId)(playbackId, props));
